...
class ScanMapStatus {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('scan_status')) {
        this.scan_status = initObj.scan_status
      }
      else {
        this.scan_status = '';
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [scan_status]
    bufferOffset = _serializer.string(obj.scan_status, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ScanMapStatus(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [scan_status]
    data.scan_status = _deserializer.string(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += _getByteLength(object.scan_status);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ScanMapStatus(null);
    ...
    if (msg.scan_status !== undefined) {
      resolved.scan_status = msg.scan_status;
    }
    else {
      resolved.scan_status = ''
    }
