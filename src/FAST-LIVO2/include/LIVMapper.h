...
public:
  ...
  void handleLIO();
  void savePCD();
  void saveLAS_RGB(pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud, const std::string& filename);
  void saveLAS_Intensity(pcl::PointCloud<pcl::PointXYZINormal>::Ptr cloud, const std::string& filename);
  void processImu();
